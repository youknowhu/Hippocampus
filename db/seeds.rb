...
listing1 = Listing.create!(host_id: user2.id, title: 'Treehouse Getaway',
...
review1 = Review.create!(user_id: user5.id, listing_id: listing1.id,
...
review2 = Review.create!(user_id: user3.id, listing_id: listing1.id,
...
review3 = Review.create!(user_id: user4.id, listing_id: listing1.id,
